...
public interface Contenido {
    ...
    /**
     * Método que busca el predecesor e inserta el contenido después del
     * predecesor en la lista de reproducción
     *
     * @param el contenido
     * @param su predecesor
    ...
    /**
     * Método que elimina el contenido pasado de la emisora (solo la primera
